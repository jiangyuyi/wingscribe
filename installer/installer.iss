...
[Files]
; Virtual environment with pre-installed packages (CPU version)
Source: "build-cpu\venv\*"; DestDir: "{app}\venv"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: main
